...
export default function ESignatureApp() {
  ...
  return (
    <div className="container text-center">
      ...
      <Title classes={"sub-title mb-4"} text={!date? "DoB": date} />
      <p>
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nesciunt nulla
        autem optio perferendis ullam error ducimus itaque dolorum, neque hic
        placeat, repellendus veniam tempora, quos libero cumque impedit
        consectetur at?
      </p>
      <footer
        className="d-flex"
